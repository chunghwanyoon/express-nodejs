...
exports.book_list = function(req, res, next) {
    ...
    Book.find({}, 'title author')
        .populate('author') // This .populate() method will replace the stored book author id with the full author details
...
exports.book_create_post = [
    ...
    // Sanitize fields (using wildcard). wildcard means all: *
    // This one line code escape all fields in one go(rather than sanitising them individually)
    sanitizeBody('*').escape(),
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            async.parallel({
                ...
                // Mark our selected genres and checked.
...
exports.book_update_post = [
    ...
    (req, res, next) => {
        ...
        var book = new Book({
            ...
            _id: req.params.id // This is required, or a new ID will be assinged!
        });
